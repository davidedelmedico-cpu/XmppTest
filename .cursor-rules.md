...
1. **Documentazione** - Scrivere SOLO per me stesso, MAI per l'utente (FONDAMENTALE)
2. **Metodo Analitico** - Approfondire e comprendere il problema (FONDAMENTALE)
3. **Analisi Architetturale** - Cercare errori di design prima di tutto (FONDAMENTALE)
4. **Principio di Certezza** - Agire solo con comprensione chiara (FONDAMENTALE)
5. **Revisione completa del codice** - PRIMA di modificare
6. **Debug e Testing** - NON chiedere all'utente
7. **Build** - SEMPRE dopo modifiche
